...
.gradio-container { padding: 34px 40px !important; }
.app-shell { max-width: 1480px; margin: 0 auto; }
.page-header { margin-bottom: 26px; }
.page-title { margin: 0; font-size: 28px; line-height: 1.1; color: var(--text); font-weight: 800; letter-spacing: -0.035em; }
.page-subtitle { margin: 10px 0 0; font-size: 14px; color: #344054; font-weight: 500; }

.gradio-container .tab-nav { border-bottom: 1px solid var(--line) !important; margin-bottom: 26px !important; }
.gradio-container .tab-nav button { font-size: 14px !important; font-weight: 650 !important; color: #475467 !important; background: transparent !important; border: 0 !important; border-bottom: 2px solid transparent !important; border-radius: 0 !important; padding: 10px 14px !important; }
.gradio-container .tab-nav button:hover { color: var(--text) !important; }
.gradio-container .tab-nav button.selected { color: var(--accent) !important; border-bottom-color: var(--accent) !important; background: transparent !important; }

.monitor-layout, .results-layout { gap: 22px !important; align-items: start !important; }
.monitor-stack { gap: 16px !important; }
.primary-panel, .secondary-panel { background: var(--panel) !important; border: 1px solid var(--line) !important; border-radius: var(--radius) !important; overflow: visible !important; }
.primary-panel { padding: 22px !important; box-shadow: 0 16px 40px rgba(17, 24, 39, 0.075) !important; }
.secondary-panel { padding: 18px !important; box-shadow: 0 7px 22px rgba(17, 24, 39, 0.045) !important; }

/* Remove Gradio's nested block styling inside our panels. */
.primary-panel .block, .secondary-panel .block,
.primary-panel .form, .secondary-panel .form,
.primary-panel .wrap, .secondary-panel .wrap,
.primary-panel .gr-form, .secondary-panel .gr-form,
.primary-panel .gr-box, .secondary-panel .gr-box,
.primary-panel .gr-markdown, .secondary-panel .gr-markdown,
.primary-panel .gr-html, .secondary-panel .gr-html,
.primary-panel .prose, .secondary-panel .prose {
  background: transparent !important;
  border: 0 !important;
  box-shadow: none !important;
}
.primary-panel label, .secondary-panel label { color: var(--muted) !important; font-size: 12px !important; font-weight: 700 !important; }

.section-title { margin: 0 0 4px; color: var(--text); font-size: 17px; line-height: 1.25; font-weight: 800; letter-spacing: -0.025em; }
.helper-text { margin: 0 0 14px; color: var(--muted); font-size: 13px; line-height: 1.45; font-weight: 500; }
.k { color: var(--muted); font-size: 12px; font-weight: 700; }
.v { color: var(--text); font-size: 13px; font-weight: 750; overflow-wrap: anywhere; }
.mono { font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 12px; font-weight: 650; }

.meta-card { background: transparent !important; border: 0 !important; border-radius: 0 !important; box-shadow: none !important; padding: 11px 0 !important; }
.run-overview-grid { display: grid; gap: 0; }
.run-overview-section { border-bottom: 1px solid var(--line) !important; }
.run-overview-section:last-child { border-bottom: 0 !important; padding-bottom: 0 !important; }
.run-overview-title { margin: 0 0 8px; text-transform: uppercase; letter-spacing: .07em; font-size: 11px; color: var(--muted); font-weight: 800; }
.label-value-grid { display: grid; grid-template-columns: 96px 1fr; gap: 7px 12px; align-items: baseline; }

.status-row { display: flex; align-items: center; gap: 10px; flex-wrap: wrap; margin-bottom: 12px; }
.status-badge { display: inline-flex; align-items: center; width: fit-content; padding: 4px 10px; border-radius: 999px; font-size: 11px; line-height: 1.2; letter-spacing: .035em; font-weight: 800; border: 1px solid transparent; }
...
.status-idle { background: #f2f4f7; color: #475467; border-color: #e4e7ec; }
.status-info { background: #f5f3ff; color: #6d28d9; border-color: #ddd6fe; }

.progress-shell { border: 1px solid var(--line); border-radius: var(--radius-sm); background: var(--panel-subtle); padding: 14px; margin-bottom: 12px; }
.progress-head { display: flex; justify-content: space-between; align-items: baseline; gap: 10px; margin-bottom: 10px; flex-wrap: wrap; }
.progress-title { color: var(--text); font-size: 14px; font-weight: 800; }
.progress-track { background: #e4e7ec; border-radius: 999px; height: 10px; overflow: hidden; }
.progress-fill { height: 100%; background: var(--accent); }
.progress-fill-running { background: linear-gradient(90deg, #818cf8, var(--accent), #818cf8); background-size: 200% 100%; animation: flow 1.5s linear infinite; }
.progress-fill-idle { background: #cbd5e1; }
.compact-meta { display: flex; align-items: center; justify-content: space-between; background: #fff !important; border: 1px solid var(--line) !important; border-radius: var(--radius-sm) !important; padding: 10px 12px !important; }
.stage-card { margin-top: 10px; background: var(--panel-subtle) !important; border: 1px solid var(--line) !important; border-radius: var(--radius-sm) !important; padding: 12px !important; }
.stage-live { display: flex; align-items: center; gap: 8px; font-size: 14px; font-weight: 800; color: var(--text); margin-bottom: 6px; }
.dot-live { width: 10px; height: 10px; border-radius: 50%; background: #22c55e; animation: pulseDot 1.3s ease-in-out infinite; }
.spinner { width: 12px; height: 12px; border: 2px solid #c7d2fe; border-top-color: var(--accent); border-radius: 50%; animation: spin .9s linear infinite; }
.status-divider { margin-top: 8px; padding-top: 8px; border-top: 1px solid var(--line); }
.timeline-wrap { margin-top: 8px; }
.timeline-card { margin-bottom: 8px; background: #fff !important; border: 1px solid var(--line) !important; border-radius: var(--radius-sm) !important; padding: 12px !important; }
...
.empty-state { border: 1px dashed var(--line-strong); border-radius: var(--radius-sm); background: var(--panel-subtle); padding: 14px; }
.empty-state-title { font-size: 14px; color: var(--text); font-weight: 800; margin-bottom: 4px; }
.empty-state-copy { font-size: 13px; color: var(--muted); font-weight: 500; line-height: 1.45; }

.primary-action, .primary-action button { background: var(--accent) !important; border-color: var(--accent) !important; color: #fff !important; font-weight: 800 !important; }
.primary-action:hover, .primary-action button:hover { background: var(--accent-strong) !important; border-color: var(--accent-strong) !important; }
.secondary-action, .secondary-action button { background: #fff !important; border: 1px solid var(--line-strong) !important; color: #344054 !important; font-weight: 750 !important; }
.secondary-action:hover, .secondary-action button:hover { background: #f8fafc !important; }

.resizable-table { overflow-x: auto; }
.resizable-table table { border-collapse: separate !important; border-spacing: 0 !important; width: 100%; }
.resizable-table table th { background: #f8fafc !important; color: #475467 !important; border-bottom: 1px solid var(--line) !important; font-weight: 800 !important; font-size: 12px !important; padding: 11px 12px !important; }
.resizable-table table td { border-bottom: 1px solid #eef2f6 !important; padding: 12px !important; vertical-align: middle !important; }
.resizable-table table tr:hover td { background: #fbfcff !important; }
...
@media (max-width: 980px) { .gradio-container { padding: 22px !important; } .label-value-grid { grid-template-columns: 1fr; gap: 2px; } }
</style>
        ...
        with gr.Tab("Monitor"):
            ...
            with gr.Row(elem_classes=["monitor-layout"]):
                with gr.Column(scale=1, elem_classes=["monitor-stack"]):
                    with gr.Column(elem_classes=["secondary-panel"]):
                ...
                with gr.Column(scale=3, elem_classes=["monitor-stack"]):
                    with gr.Column(elem_classes=["primary-panel", "monitor-primary"]):
